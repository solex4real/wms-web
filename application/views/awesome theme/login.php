...
<!--external css-->
<!-- font icon -->
<link href="<?= base_url();?>css/elegant-icons-style.css"
	rel="stylesheet" />
...
<body class="login-img3-body">
	<div class="container">
		<form class="login-form"
			action="<?php echo form_open('main/login_validation'); ?>">
			<div class="login-wrap">
				...
				<label class="checkbox"> <input type="checkbox" value="remember-me">
					Remember me <span class="pull-right"> <a href="#"> Forgot Password?</a></span>
				</label>
				<button id="login_submit" name="login_submit" value="Login"
