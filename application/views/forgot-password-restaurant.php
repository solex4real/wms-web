...
<body class="login-content">
	<!-- Login -->
        <?php echo form_open('restaurant/forgot_password', ['class' => 'lc-block toggled', 'role' => 'form', 'id' => 'l-forgot-pasword']); ?>
           <p class="text-left">Enter your email to recover your password.</p>
            
            <div class="input-group m-b-20">
                <span class="input-group-addon"><i class="md md-email"></i></span>
                <div class="fg-line">
                    <?php echo form_input(['name' => 'email-password', 'id' => 'email-password', 'class' => 'form-control', 'value' => set_value('email'), 'placeholder' => 'Email Address']); ?>
                </div>
            </div>
            
            <button href="" type="submit" class="btn btn-login btn-danger btn-float"><i class="md md-arrow-forward"></i></button>
