<!DOCTYPE html>
    ...
    <head>
        ...
        <!-- CSS -->
        <link href="<?= base_url();?>material/css/app.min.1.css" rel="stylesheet">
        <link href="<?= base_url();?>material/css/app.min.2.css" rel="stylesheet">
    </head>
    ...
    <body class="four-zero-content">        
        <div class="four-zero">
            ...
            <footer>
                ...
                <a href="<?= base_url();?>"><i class="md md-home"></i></a>
            </footer>
        </div>
