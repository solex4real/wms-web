...
<body class="login-content">
	<div class="col-sm-12 p-absolute p-10">
        ...
        onclick="location.href='<?php echo base_url();?>main/login'">User Login</button>
        </div>
	</div>


	<!-- Login -->
        <?php echo form_open('restaurant/login_validation', ['class' => 'lc-block toggled', 'role' => 'form', 'id' => 'l-login']); ?>
		...
		<div class="fg-line">
                	<?php echo form_input(['name' => 'username', 'id' => 'username', 'class' => 'form-control', 'value' => set_value('username'), 'placeholder' => 'Restaurant Username']); ?>
                </div>
	</div>
	...
	<div class="btn-group btn-group-justified" role="group" aria-label="...">
          ...
          onclick="location.href='<?php echo base_url();?>Restaurant/forgot_password'">Forgot Password</button>
          </div>
	</div>
