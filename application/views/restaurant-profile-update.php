...
?>
		<section id="content">
			...
			<div class="card profile" >
				<div class="profile__img" id="message-icon">
					...
					<a class="zmdi zmdi-email profile__img__edit"></a>
				</div>

				<div class="profile__info">
					<p><?php echo $data_restaurant->description;?></p>
			...
			<div class="card profile-main">
				<div class="pm-body clearfix" role="tabpanel"> 
					<ul class="tab-nav tn-justified">
					 ...
					 <div class="pmb-block clearfix photos tab-content p-25">
			...
			<div class="modal fade" id="send-message-modal" data-backdrop="static"
				data-keyboard="false">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Restaurant Message</h4>
						</div>
						<div class="modal-body">
							
							<form role="form" class="form-group" id="form-res-message">
                                <div class="fg-line">
                                    <textarea class="form-control" rows="5" placeholder="Let us know what your concern..." id="res-message" required></textarea>
                                </div>
                            </form>
						</div>
						<div class="modal-footer">
							<button onclick="send_feedback()" class="btn btn-link" id="confirm_reservation">Send</button>
	...
	<script type="text/javascript"> 
		...
		//Show message dialog
		$('#message-icon').unbind('click').bind('click', function(){
