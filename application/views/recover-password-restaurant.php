...
<body class="login-content">
	<!-- Login -->
        <?php echo form_open('restaurant/recover_login/'.$restaurant_id."/".$link_id, ['class' => 'lc-block toggled', 'role' => 'form', 'id' => 'l-recover-pasword']); ?>
           <p class="text-left">Enter your new password.</p>
            ...
            <a href=""  type="submit" class="btn btn-login btn-danger btn-float"><i  class="md md-arrow-forward"></i></a>
