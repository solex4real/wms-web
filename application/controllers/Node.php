...
//define("NODE_DIR", "C:\\Program^ Files\\nodejs\\node.exe");
define("NODE_DIR", "C:/Program Files/nodejs");
...
class Node extends CI_Controller {
	...
	private function node_uninstall() {
		if(!file_exists(NODE_DIR)) {
	...
	public function node_start($file="C:/xampp/htdocs/wms-web/server.js") {
		if(!file_exists(NODE_DIR)) {
		...
		//$node_pid = exec("PORT=" . NODE_PORT . " " . NODE_DIR . "node $file >nodeout 2>&1 & echo $!");
